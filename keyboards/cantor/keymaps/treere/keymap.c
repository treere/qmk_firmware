...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_SCLN, KC_MINS, KC_LCTL, LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RCTL_T(KC_K), LALT_T(KC_L), RGUI_T(KC_P), KC_QUOT, CW_TOGG, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, TO(0), LT(3,KC_SPC), KC_BSPC, KC_ENT, TT(1), TT(2)),
	[1] = LAYOUT_split_3x6_3(KC_ESC, KC_CIRC, KC_LT, KC_AT, KC_GT, KC_PIPE, KC_NO, KC_LCBR, KC_SCLN, KC_RCBR, KC_TILD, KC_NO, KC_NO, KC_AMPR, KC_LBRC, KC_EXLM, KC_RBRC, KC_PERC, KC_QUOT, KC_LPRN, KC_COLN, KC_RPRN, KC_DQUO, KC_NO, KC_NO, KC_GRV, KC_HASH, KC_DLR, KC_QUES, KC_BSLS, KC_NO, KC_UNDS, KC_EQL, KC_MINS, KC_NO, KC_NO, TO(0), KC_SPC, KC_BSPC, KC_ENT, KC_TRNS, TT(2)),
