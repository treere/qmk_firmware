...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x6_3(KC_NO, KC_PAST, KC_1, KC_2, KC_3, KC_PPLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_0, KC_4, KC_5, KC_6, KC_PMNS, KC_NO, KC_NO, KC_PEQL, KC_PAST, KC_PSLS, KC_NO, KC_NO, KC_PSLS, KC_7, KC_8, KC_9, KC_EQL, KC_NO, KC_NO, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_NO, KC_SPC, KC_ENT, KC_NO, KC_NO, KC_NO)
};
